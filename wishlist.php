...
<section class="products">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="flex">
         <div class="price"><?=number_format($fetch_wishlist['price']); ?>VND</div>
         <input type="number" name="qty" class="qty" min="1" max="99" onkeypress="if(this.value.length == 2) return false;" value="1">
      </div>
      <input type="submit" value="Thêm vào giỏ" class="btn" name="add_to_cart">
      <input type="submit" value="Xóa sản phẩm" onclick="return confirm('delete this from wishlist?');" class="delete-btn" name="Xóa">
   </form>
   <?php
      }
   }else{
   ...
   <div class="wishlist-total">
      <p>Tổng giá : <span><?= number_format($grand_total); ?>VND</span></p>
